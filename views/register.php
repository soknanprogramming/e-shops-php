    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @media (max-width: 480px) {
            ...
            .register-header .welcome-text { font-size: 1.35rem; }
            .form-row { grid-template-columns: 1fr; gap: 1.125rem; }
        }
...
<body>
    <?php
    // Retrieve preserved input from session (if any)
    $old = $_SESSION['register_input'] ?? [];
    unset($_SESSION['register_input']); // Clear after reading
    ?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-wrapper">
                        ...
                        <button type="button" class="toggle-password" onclick="togglePass('password')">
                            ...
                            <svg class="eye-off" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="display:none">
    ...
    <script>
        function togglePass(inputId) {
            ...
            if (input.type === 'password') {
                input.type = 'text';
                wrapper.querySelector('.eye-on').style.display = 'none';
                wrapper.querySelector('.eye-off').style.display = 'block';
            } else {
                input.type = 'password';
                wrapper.querySelector('.eye-on').style.display = 'block';
                wrapper.querySelector('.eye-off').style.display = 'none';
            }
        }
    </script>
</body>
